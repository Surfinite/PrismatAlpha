...
public:
    ...
    PartialPlayer_Breach_GreedyKnapsack(const PlayerID playerID, bool lowTechPriority, bool legacy = true, EvaluationType (*heuristic)(const Card &, const GameState &, const HealthType) = &Heuristics::DamageLoss_WillCost);
